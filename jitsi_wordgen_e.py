...
try:
    ...
    for w in range (a):
        for x in range(b):
            for y in range(c):
                for z in range(d):
                    file.write(ADJECTIVE[y]+PLURALNOUN[w]+VERB[x]+ADVERB[z]+os.linesep)
                    o=o+1
                    if (o==10000000):
                    	file.close()
                    	g=g+1
                    ...
                    if(x==b):
                        w=w+1
    print("Done! Exiting from program...")
except KeyboardInterrupt:
    print('\n finishing... (Remember: all generated names are located in E: disk)')
    file.close()
